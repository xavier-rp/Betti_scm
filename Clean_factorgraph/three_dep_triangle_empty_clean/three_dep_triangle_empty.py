...
if __name__ == '__main__':
    ...
    #with open('factorgraph_three-dep_triangle_empty.pkl', 'wb') as output:
    ...
    #    np.save('/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/three_dep_triangle_empty_clean/data_100/bipartite_' + str(i), bipartite)
    ...
    for i in np.arange(0, 10000, 1):
        ...
        bam = np.load('/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/three_dep_triangle_empty_clean/data_100/bipartite_' +str(i) + '.npy')
        #print(bam.shape)
        ...
        analyser = Analyser(bam, '/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/three_dep_triangle_to_simplex_clean/factorgraph_three-ind')
    ...
    list_of_pval_list.append(deepcopy(pval_list))
    ...
    for i in np.arange(0, 10000, 1):
        ...
        bam = np.load(
            '/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/three_dep_triangle_empty_clean/data_100/bipartite_' + str(
                i) + '.npy')
    ...
    for alpha in np.arange(0, 0.1001, 0.001):
        ...
        comptelist.append(compte)
    print(comptelist)
    comptelist = np.array(comptelist) / 299
    # plt.plot(np.arange(0, 0.101, 0.001), np.array(comptelist)/1000)
    rc('text', usetex=True)
    rc('font', size=16)
    plt.plot(np.arange(0, 0.101, 0.001), comptelist, color='#ff7f00ff',
             linewidth='2', label='Proportion de rejet')
