...
if __name__ == '__main__':
    ...
    #    np.save('/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/three_dep_triangle_real_empty_clean/data_100/bipartite_' + str(i), bipartite)
    ...
    for i in np.arange(0, 10000, 1):
        ...
        bam = np.load('/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/three_dep_triangle_real_empty_clean/data_100/bipartite_' +str(i) + '.npy')
        #print(bam.shape)
        ...
        #print(cont_table)
        #print(exp)
        distance_list.append(round(distance_to_original(bam, table_test)))
    ...
    rc('font', size=16)
    plt.figure(1)
    n, b, p = plt.hist(distance_list, bins=np.arange(0, 300,1)-0.5, color='#00a1ffff')
    plt.xlabel('Distance $L_1$')
