...
if __name__ == '__main__':
    ...
    for i in np.arange(0, 10000, 1):
        ...
        np.save('/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/three_dep_triangle_to_simplex_clean/data_100_3/bipartite_' + str(i), bipartite)
    ...
    for i in np.arange(0, 10000, 1):
        ...
        bam = np.load('/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/three_dep_triangle_to_simplex_clean/data_100_2/bipartite_' +str(i) + '.npy')
        #print(bam.shape)
