...
if __name__ == '__main__':
    ...
    #    np.save('/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/two_disco/data_100/bipartite_' + str(i), bipartite)
    ...
    for i in np.arange(0, 1000, 1):
        ...
        bam = np.load('/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/two_disco/data_100/bipartite_' +str(i) + '.npy')
    ...
    pval_list = np.load('/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/two_disco/pval_list_100.npy')
    plt.figure(1)
    ...
    for i in range(1000):
        bam = np.load(
            '/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/two_disco/data_100/bipartite_' + str(
                i) + '.npy')
