...
class FactorGraph():
    ...
    def threefactor_table_entry(self, node_states, weight, a=1, b=1, c=1, d=1, e=1, f=1, g=1, h=1):
        x1 = node_states[0]
        x2 = node_states[1]
        x3 = node_states[2]
    ...
    def twofactor_table_entry_pos(self, node_states, weight, a=np.log(48), b=np.log(2), c=np.log(2), d=np.log(48)):
