...
if __name__ == '__main__':
    #factorgraph = FactorGraph([[0, 1, 2], [2, 3]], N=1000, alpha=0.01)

    #with open('012_23_N1000.pkl', 'wb') as output:
    ...
    #    sampler = Sampler(proposer, temperature=1, initial_burn=5, sample_burn=32)
    #    sampler.sample(1000)
