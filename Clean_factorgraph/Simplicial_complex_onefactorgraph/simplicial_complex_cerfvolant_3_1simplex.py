...
if __name__ == '__main__':
    ...
    #    factorgraph = FactorGraph([[0, 1, 2], [2, 3], [3, 4], [4, 5]], N=400, alpha=0.01)
    ...
    #    np.save(
    #        '/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/Simplicial_complex_deux_facettes/data_01_cerfvolant_3_1simplexe_400_moreburn/bipartite_' + str(
    #            i), bipartite)
    ...
    for i in np.arange(0, 1000, 1):
        ...
        bam = np.load(
            '/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/Simplicial_complex_deux_facettes/data_01_cerfvolant_3_1simplexe_400/bipartite_' + str(
                i) + '.npy')
        nb_found_links = 0
