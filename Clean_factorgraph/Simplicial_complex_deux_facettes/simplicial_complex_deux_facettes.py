...
if __name__ == '__main__':
    ...
    #    factorgraph = FactorGraph([[0, 1, 2], [3, 4]], N=400, alpha=1e-5)
    ...
    #    np.save(
    #        '/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/Simplicial_complex_deux_facettes/data_1e-6_two_facets_disco_400/bipartite_' + str(
    #            i), bipartite)
