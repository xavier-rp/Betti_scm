...
if __name__ == '__main__':
    ...
    #    factorgraph = FactorGraph([[0, 1, 2], [2, 3]], N=100, alpha=0.01)
    ...
    #    np.save(
    #        '/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/Simplicial_complex_deux_facettes/data_01_two_facets_disco_100/bipartite_' + str(
    #            i), bipartite)

    #exit()
    factorgraph = FactorGraph([[0, 1, 2], [2, 3]], N=400, alpha=0.01)
    list_of_pval_list = []
    pval_list = []
    distance_list = []
    link_count = []
    ...
    print(compte_0_1_3)
    print('Nb we found [2, 3] : ', np.sum(np.array(link_found_list)), np.sum(np.array(nb_found_links_list)))
