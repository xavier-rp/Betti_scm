...
Time take =  8439.600536999998
    ...
    #exit()
    start = time.clock()
    filename = 'dep_50_times50samples'

    original_table = np.array([[[50, 0], [0, 50]], [[0, 50], [50, 0]]])
    ...
    for i in range(0, 10):
        ...
        ratio_list = [1]
        for number_to_partition in range(48, 51, 1):
            ...
            for i in range(0, 50*number_of_samples):
