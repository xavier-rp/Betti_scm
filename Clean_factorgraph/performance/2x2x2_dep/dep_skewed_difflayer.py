...
if __name__ == '__main__':
    ...
    ind_50 = np.load('dep_40_50_60_50.npy')
    ind_75 = np.load('dep_30_50_70_50.npy')

    ind_another = np.load('dep_40_50_50_60.npy')
    ind_another1 = np.load('dep_30_50_50_70.npy')
    ...
    plt.plot(np.arange(0, 2 * len(np.mean(ind_25, axis=0)), 2), np.mean(ind_50, axis=0), marker='x', label='40_50_60_50')
    ...
    plt.plot(np.arange(0, 2 * len(np.mean(ind_25, axis=0)), 2), np.mean(ind_75, axis=0), marker='x', label = '30_50_70_50')
    ...
    plt.plot(np.arange(0, 2 * len(np.mean(ind_25, axis=0)), 2), np.mean(ind_another, axis=0), marker='x',
             label='40_50_50_60')

    plt.fill_between(np.arange(0, 2 * len(np.mean(ind_25, axis=0)), 2),
                     np.mean(ind_another, axis=0) + np.std(ind_another, axis=0),
                     np.mean(ind_another, axis=0) - np.std(ind_another, axis=0), alpha=0.2)

    plt.plot(np.arange(0, 2 * len(np.mean(ind_25, axis=0)), 2), np.mean(ind_another1, axis=0), marker='x',
             label='30_50_50_70')

    plt.fill_between(np.arange(0, 2 * len(np.mean(ind_25, axis=0)), 2),
                     np.mean(ind_another1, axis=0) + np.std(ind_another1, axis=0),
                     np.mean(ind_another1, axis=0) - np.std(ind_another1, axis=0), alpha=0.2)
