...
if __name__ == '__main__':
    ...
    factorgraph = FactorGraph([[0, 1, 2], [3, 4]], N=400, alpha=0.01)
    #probdist = Prob_dist(factorgraph)

    with open('fg.pkl', 'wb') as output:
    ...
    np.save('/home/xavier/Documents/Projet/Betti_scm/Clean_factorgraph/Simplicial_complex/data/bipartite_matrix', bipartite)
